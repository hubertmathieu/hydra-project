...
#define FILTER_PUMP_RELAY_PIN 4//rouge
#define SPRAYER_PUMP_RELAY_PIN 5//jaune
#define SPRAYER1_SWITCH_PIN 6 //orange gauche
#define SPRAYER2_SWITCH_PIN 7//vert milieu
#define SPRAYER3_SWITCH_PIN 8//bleu droite
#define SERVO1_PIN A0
#define SERVO2_PIN A1
#define SERVO3_PIN A2
#define SERVO4_PIN A3 //phDown
